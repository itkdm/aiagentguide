...
如果一开始就直接看定义，很多新手会觉得 <span class="case-accent">AI Agent</span> **“好像懂了，但脑子里没有画面”**。
...
如果是第一次接触，我建议你优先用下面 3 个案例建立第一层直觉：

* **会议准备助手**：最容易理解“搜集资料 -> 整理交付”
* **招聘流程助手**：最容易理解“多输入判断 -> 推荐输出”
* **旅行规划助手**：最容易理解“目标明确，但路径不固定”

这 3 个案例分别对应了 3 种很典型的 Agent 任务结构。
只要你先把这三种结构看明白，后面再看其他例子就会顺很多。
