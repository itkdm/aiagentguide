...
先给结论：**解码策略决定“从概率分布里选哪个 token”，温度控制随机性，top-k/top-p 控制候选范围。** citeturn1search0turn2view0

这部分会把常见采样参数讲清楚，帮助你知道为什么同一提示会有不同答案，以及怎样让输出更稳定或更有创造性。citeturn1search0turn2view0
