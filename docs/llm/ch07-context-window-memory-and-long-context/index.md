...
先给结论：**LLM 的“记住”主要来自上下文窗口，而不是长期记忆；上下文长度是硬约束，且越长不一定越好用。** citeturn2search3turn0search4

本章会帮助你建立三类判断：  
模型到底能“看到”多少信息、哪些记忆是参数内化、哪些是上下文临时、以及为什么长上下文仍然需要检索与组织。citeturn2search3turn0search4
