---
title: 通用 Agent 原理：MCP
description: "从 Host、Client、Server 以及 Tools、Resources、Prompts 三类能力出发，解释 MCP 如何标准化 AI 应用与外部系统的连接。"
summary: 理解 MCP 解决的是 Agent 接入外部工具和数据时的协议与边界问题，以及它和直接编写适配器的区别。
keywords:
  - MCP 原理
...
1. MCP 是什么
2. MCP 在解决什么问题
3. MCP 的核心角色：Host / Client / Server
4. MCP 暴露的三类能力：Tools / Resources / Prompts
5. 一个最小 Python 版本
6. 这段代码里对应的关键动作
7. 为什么 MCP 比直接写适配器更值得讲
8. MCP 和工具、Skill 的关系
9. 更贴近真实 MCP 的流程
10. resources 和 prompts 为什么也重要
11. MCP 不会自动替你解决所有问题
12. 安全为什么在 MCP 里尤其重要
13. 一个更工程化的理解方式
14. 这一篇真正要理解什么
